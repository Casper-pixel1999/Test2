...
export const BUILD_PADS: BuildPadDef[] = [
  { id: 'table_1', kind: 'table', x: 2.2, z: 1.4, cost: 0, xp: 5, requires: [], minLevel: 1, tableIndex: 0, labelKey: 'pad_table_1' },
  { id: 'grill_1', kind: 'grill', x: -7.2, z: -1.6, cost: 40, xp: 12, requires: ['table_1'], minLevel: 1, labelKey: 'pad_grill_1' },
  { id: 'counter_1', kind: 'counter', x: -2.0, z: 0.4, cost: 50, xp: 12, requires: ['grill_1'], minLevel: 1, labelKey: 'pad_counter_1' },
  { id: 'table_2', kind: 'table', x: 4.8, z: 1.4, cost: 60, xp: 10, requires: ['counter_1'], minLevel: 1, tableIndex: 1, labelKey: 'pad_table_2' },
  { id: 'expand_hr', kind: 'expand_hr', x: -9.0, z: -7.0, cost: 120, xp: 20, requires: ['table_2'], minLevel: 2, labelKey: 'pad_expand_hr' },
  { id: 'expand_player', kind: 'expand_player', x: -5.5, z: -7.0, cost: 150, xp: 20, requires: ['expand_hr'], minLevel: 2, labelKey: 'pad_expand_player' },
  { id: 'table_3', kind: 'table', x: 7.4, z: 1.4, cost: 100, xp: 12, requires: ['expand_player'], minLevel: 2, tableIndex: 2, labelKey: 'pad_table_3' },
  { id: 'expand_street', kind: 'expand_street', x: 3.0, z: -7.5, cost: 200, xp: 25, requires: ['table_3'], minLevel: 3, labelKey: 'pad_expand_street' },
  { id: 'drive_thru', kind: 'drive_thru', x: 9.8, z: -6.2, cost: 280, xp: 30, requires: ['expand_street'], minLevel: 3, labelKey: 'pad_drive_thru' },
  { id: 'grill_2', kind: 'grill2', x: -7.2, z: -4.0, cost: 320, xp: 28, requires: ['grill_1'], minLevel: 4, labelKey: 'pad_grill_2' },
  { id: 'table_4', kind: 'table', x: 2.2, z: 3.8, cost: 180, xp: 14, requires: ['grill_2'], minLevel: 4, tableIndex: 3, labelKey: 'pad_table_4' },
  ...
  { id: 'expand_restroom', kind: 'expand_restroom', x: 0.2, z: -7.5, cost: 300, xp: 24, requires: ['expand_hr'], minLevel: 6, labelKey: 'pad_expand_restroom' },
  { id: 'table_5', kind: 'table', x: 4.8, z: 3.8, cost: 220, xp: 14, requires: ['expand_restroom'], minLevel: 6, tableIndex: 4, labelKey: 'pad_table_5' },
  { id: 'cashier_desk', kind: 'cashier_desk', x: -2.0, z: 2.6, cost: 400, xp: 35, requires: ['counter_1'], minLevel: 5, labelKey: 'pad_cashier_desk' },
